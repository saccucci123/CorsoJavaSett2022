    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
         <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="aggiungiAutomobile" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>Aggiungi Auto</p>
            </a>
          </li>
...
<div class= "form-group">
<label>MODELLO</label>
<input id="modello" class= "form-control" name="id" type="text" value="">
</div>

<div class= "form-group">
<label>ANNO </label>
<input id="anno" class= "form-control" name="id" type="text" value="">
</div>
