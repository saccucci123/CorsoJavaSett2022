...
$(document).ready(function(){
	...
	  datas=fire_ajax_get("http://localhost:8080/DS_geo_1.1_ms/listaRegioni");
	...
	$("#regione").change(function() {
		...
		   $("#provincia").empty();
		   //$('#tableDatas tbody').empty();
		  datas=fire_ajax_get("http://localhost:8080/DS_geo_1.1_ms/listaProvince?id_regione=" +idRegione);
		   //var table = $("#tableDatas tbody");
	...
	$("#provincia").change(function() {
		...
		   $("#comune").empty();
		   //$('#tableDatas tbody').empty();
		  datas=fire_ajax_get("http://localhost:8080/DS_geo_1.1_ms/listaComuni?sigla=" +sigla);
		   //var table = $("#tableDatas tbody");
	...
	$("#meteoAuto").autocomplete({
	    source: function( request, response ) {
	      $.ajax({
	        url: "http://localhost:8080/DS_geo_1.1_ms/listaComuniAutocomplete?text="+request.term,
	        dataType: "json",
	...
	var previsioni=fire_ajax_get("http://localhost:8080/DS_geo_1.1_ms/getMeteo?istat="+istat);
	var iconaMeteo;
