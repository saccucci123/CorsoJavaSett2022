...
$(document).ready(function() {
	...
	$("#bg1").click(
		function() { ultimaCellaPienaC1 = ultimaCellaPienaC1 - 1; 
	...
	$("#bg2").click(
		function() { ultimaCellaPienaC2 = ultimaCellaPienaC2 - 1; 
	...
	$("#br3").click(
		function() { ultimaCellaPienaC3 = ultimaCellaPienaC3 - 1; 
	...
	$("#bg4").click(
		function() { ultimaCellaPienaC4 = ultimaCellaPienaC4 - 1; 
	...
	$("#bg5").click(
		function() { ultimaCellaPienaC5 = ultimaCellaPienaC5 - 1; 
	...
	$("#bg6").click(
		function() { ultimaCellaPienaC6 = ultimaCellaPienaC6 - 1; 
	...
	$("#bg7").click(
		function() { ultimaCellaPienaC7 = ultimaCellaPienaC7 - 1; 
	...
	$("#bg8").click(
		function() { ultimaCellaPienaC8 = ultimaCellaPienaC8 - 1; 
...
function controllaVincita(x, y) {
	...
	for (var i = 8; i > 0; i--) { 
		...
		if (contacolonneRosse == 4) { alert("Hai vinto rosso con col"); 
		contacolonneRosse = 0; } 
		else if (contacolonneGialle == 4) 
		{ alert("Hai vinto giallo con col"); contacolonneGialle = 0; } }
	//Verifica per riga
	...
	for (var j = 0; j < 9; j++) {
		...
		if (contacelleRosse == 4) { alert("Hai vinto rosso con rig"); contacelleRosse = 0; } 
		else if (contacelleGialle == 4) { alert("Hai vinto giallo con rig"); contacelleGialle = 0; }
	}
}
